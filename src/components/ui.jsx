...
function Shimmer({ className, w, h, rounded = "xl" }) {
  return <motion.div
    className={cn(
...
const BRANDS = {
  ...
  tiktok: { bg: "#0f0f0f", label: "TikTok" },
  linkedin: { bg: "#0A66C2", label: "in" },
  microsoft: { bg: "linear-gradient(135deg,#F25022,#7FBA00)", label: "MS" },
  ...
  hp: { bg: "linear-gradient(135deg,#0096D6,#00AEEF)", label: "HP" },
  ...
  acer: { bg: "linear-gradient(135deg,#83B81A,#A3D820)", label: "ACER" },
  google: { bg: "linear-gradient(135deg,#4285F4,#34A853)", label: "Google" },
  ...
  gucci: { bg: "linear-gradient(135deg,#2E8B57,#3CB371)", label: "G" },
  louisvuitton: { bg: "linear-gradient(135deg,#B8860B,#DAA520)", label: "LV" },
  rolex: { bg: "linear-gradient(135deg,#006039,#008B4A)", label: "\u25C8" },
  bosch: { bg: "linear-gradient(135deg,#E60000,#CC0000)", label: "B" },
  ...
  lg: { bg: "linear-gradient(135deg,#A50034,#C40048)", label: "LG" },
  whirlpool: { bg: "linear-gradient(135deg,#003D7A,#005AA0)", label: "W" },
  ...
  beats: { bg: "linear-gradient(135deg,#e30b25,#b5001e)", label: "beats" },
...
function GoogleAdsLogo({ size = 44 }) {
  return <span
...
function MicrosoftLogo({ size = 44 }) {
  return <span
...
function PinterestLogo({ size = 44 }) {
  return <span
    className="inline-flex shrink-0 items-center justify-center rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden p-1.5"
    style={{ width: size, height: size }}
  >
...
function ClickBankLogo({ size = 44 }) {
  return <span
...
function ShareASaleLogo({ size = 44 }) {
  return <span
...
function ClickFunnelsLogo({ size = 44 }) {
  return <span
    className="inline-flex shrink-0 items-center justify-center rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden p-1.5"
    style={{ width: size, height: size }}
  >
...
function HostingerLogo({ size = 44 }) {
  return <span
    className="inline-flex shrink-0 items-center justify-center rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden p-1.5"
    style={{ width: size, height: size }}
  >
...
function GrammarlyLogo({ size = 44 }) {
  return <span
    className="inline-flex shrink-0 items-center justify-center rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden p-1.5"
    style={{ width: size, height: size }}
  >
...
function ClickBankLogoImg({ size = 44 }) {
  return <span
    className="inline-flex shrink-0 items-center justify-center rounded-2xl border border-slate-100 bg-white shadow-sm overflow-hidden p-1.5"
    style={{ width: size, height: size }}
  >
