...
const CATEGORIES = [
  ...
  { icon: Users, id: "affiliate-marketing", title: "Affiliate Marketing", count: "150+ Programs", bg: "bg-blue-500", image: "/images/affiliate.png" },
  ...
  { icon: Search, id: "seo-tools", title: "SEO Tools", count: "180+ Tools", bg: "bg-blue-600", image: "/images/chart-arrow-up-icon.png" },
...
function Categories() {
  return <section className="mx-auto max-w-[1440px] px-4 py-12 sm:px-8 lg:py-16">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
        {CATEGORIES.map((c, i) => <Reveal key={c.title} delay={i % 5 * 0.07}>
  ...
  >
                {c.image ? <img src={c.image} alt={c.title} className="h-full w-full object-contain" /> : <c.icon className="h-6 w-6" />}
              </span>
