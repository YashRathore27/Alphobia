...
function ToolListing() {
  ...
  const [selectedPricing, setSelectedPricing] = useState(/* @__PURE__ */ new Set());
  ...
  const clearAll = () => {
    ...
    setSelectedPricing(/* @__PURE__ */ new Set());
  };
    ...
    /* Category */
              ...
              <div>
                ...
                <div className="space-y-2.5">
                  {CATEGORY_OPTIONS.map((lbl) => <label key={lbl} className="flex cursor-pointer items-center gap-2.5 text-[13px] text-slate-600 hover:text-slate-900">
                      <input
    type="checkbox"
  ...
  />
    ...
    /* Pricing */
              ...
              <div>
                ...
                <div className="space-y-2.5">
                  {PRICING_OPTIONS.map((lbl) => <label key={lbl} className="flex cursor-pointer items-center gap-2.5 text-[13px] text-slate-600 hover:text-slate-900">
                      <input
    type="checkbox"
