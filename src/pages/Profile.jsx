...
function Profile() {
  ...
  return <div className="bg-slate-50/60 pb-16">
  ...
  />
    ...
    /* Stats */
              ...
              <div className="mt-7 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-slate-100 bg-slate-100 sm:grid-cols-4">
                {STATS.map((s) => <div key={s.label} className="bg-white p-4 text-center">
  ...
  >
              ...
              {tab === "Saved Deals" && <div className="grid gap-5 sm:grid-cols-3">
                  {SAVED.map((s) => <button
    key={s.name}
  ...
  >
              ...
              {(tab === "Comments" || tab === "Followers" || tab === "Following") && <div className="flex flex-col items-center py-10 text-center">
                  <img
  ...
  />
                  ...
                  <p className="mt-1 max-w-xs text-[13px] text-slate-400">
                    {tab === "Comments" ? "Comments you post on reviews and news will show up here." : `Your ${tab.toLowerCase()} list will show up here once you start connecting.`}
                  </p>
                  <button
