...
function Dashboard() {
  ...
  >
                ...
                {n.badge && <span
    className={`flex h-5 w-5 items-center justify-center rounded-full text-[10px] font-extrabold ${active === n.label ? "bg-white/25 text-white" : "bg-rose-500 text-white"}`}
  >
                    {n.badge}
                  </span>}
              </button>)}
  ...
  >
    ...
    /* Stats */
          ...
          <div className="grid grid-cols-2 gap-6 xl:grid-cols-4">
            {STATS.map((s, i) => <Reveal key={s.label} delay={i * 0.06}>
