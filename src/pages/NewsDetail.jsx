...
function NewsDetail({ id }) {
  ...
  />
    ...
    return <button
      ...
      className={`relative flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-left text-[12px] font-semibold transition-all ${isActive ? "text-indigo-600" : "text-slate-500 hover:text-slate-800"}`}
    >
