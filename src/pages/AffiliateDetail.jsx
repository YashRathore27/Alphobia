...
function EarningsCalculator({ visitors: defVis, conversion: defConv, aov: defAov }) {
  ...
  return <div className="rounded-2xl border border-[#EEF2F7] bg-white p-6 shadow-[0_8px_24px_rgba(0,0,0,0.05)]">
      ...
      <div className="mt-5 space-y-5">
        <Slider label="Monthly Visitors" value={visitors} setValue={setVisitors} min={1e3} max={1e5} step={1e3} fmt={(n) => n.toLocaleString()} />
...
function AffiliateDetail({ id }) {
  const [activeSection, setActiveSection] = useState("overview");
  const [saved, setSaved] = useState(false);
  const sectionRefs = useRef({});
  const aff = id ? AFFILIATES_DATA[id] : void 0;
  if (!aff) {
    ...
    /* Right — Summary CTA Card */
            ...
            <div className="rounded-[20px] border border-[#EEF2F7] bg-white p-7 shadow-[0_8px_24px_rgba(0,0,0,0.05)]">
              <div className="divide-y divide-[#E5E7EB]">
                {aff.stats.map((s) => <div key={s.label} className="flex items-center justify-between py-3 first:pt-0 last:pb-0">
  ...
  >
            ...
            <div className="mt-14">
              ...
              <div className="mt-6">
                ...
                <ul className="mt-4 space-y-3">
                  {aff.requirements.map((r) => <CheckItem key={r}>{r}</CheckItem>)}
                </ul>
              </div>
              <div className="mt-8">
    ...
    /* ─────── COMMISSION SECTION ─────── */
        ...
        <section id="commission" ref={(el) => {
    sectionRefs.current.commission = el;
  }} className="scroll-mt-28">
          <Reveal>
            <div className="mt-14">
    ...
    /* ─────── PAYOUT SECTION ─────── */
        ...
        <section id="payout" ref={(el) => {
    sectionRefs.current.payout = el;
  }} className="scroll-mt-28">
          <Reveal>
            <div className="mt-14">
