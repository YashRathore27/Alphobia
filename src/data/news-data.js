const NEWS_DATA = {
  "google-ads-ai": {
    ...
    author: "Alphobia Team",
    date: "May 12, 2024",
    readTime: "6 min read",
    paragraphs: [
      { type: "text", content: [
        "Google has announced new AI-powered features in Google Ads that help advertisers optimize campaigns, improve targeting, and get better results. The rollout marks the biggest update to the platform since the introduction of Performance Max campaigns.",
      ...
      { type: "callout", content: ["\u{1F4A1} Pro Tip: Pair the new AI features with the current Google Ads 40% bonus credit deal to test the tools with reduced risk."] },
  ...
  "meta-ad-tools": {
    ...
    paragraphs: [
      { type: "text", content: [
        "Meta has unveiled a new suite of Advantage+ advertising tools designed to help businesses maximize their return on ad spend across Facebook and Instagram. The AI-driven tools automate campaign optimization, creative generation, and audience targeting.",
      ...
      { type: "callout", content: ["\u{1F4A1} Pro Tip: Start with a small budget to test Advantage+ before scaling. The AI needs about 50 conversions to optimize effectively."] },
  ...
  "tiktok-ad-update": {
    ...
    paragraphs: [
      { type: "text", content: [
        "TikTok has rolled out major updates to its advertising platform, introducing new targeting capabilities that give businesses more precision when reaching their ideal audience on the rapidly growing social platform.",
  ...
  "microsoft-ad-ai": {
    ...
    paragraphs: [
      { type: "text", content: [
        "Microsoft Advertising has announced a comprehensive update to its platform, introducing AI-powered features that help advertisers optimize bids, create better ad copy, and reach more relevant audiences across the Microsoft Search Network.",
      ...
      { type: "callout", content: ["\u{1F4A1} Pro Tip: Start with automated bidding on high-performing campaigns to maximize the benefit of Microsoft's AI features."] },
  ...
  "linkedin-b2b-tools": {
    ...
    paragraphs: [
      { type: "text", content: [
        "LinkedIn has introduced a suite of new B2B marketing tools designed to help businesses generate high-quality leads and build meaningful professional relationships. The updates focus on account-based marketing (ABM) and improved targeting capabilities.",
      ...
      { type: "callout", content: ["\u{1F4A1} Pro Tip: Use LinkedIn's ABM tools to target specific companies with personalized campaigns for higher conversion rates."] },
  ...
  "pinterest-trends": {
    ...
    paragraphs: [
      { type: "text", content: [
        "Pinterest has released its annual marketing trends report, revealing key insights into consumer behavior and emerging trends that marketers need to know for the coming year. The report analyzes data from over 480 million monthly active users.",
  ...
  "instagram-reels-ads": {
    ...
    paragraphs: [
      { type: "text", content: [
        "Instagram has announced significant expansions to its Reels advertising options, giving brands more ways to reach audiences through short-form video content. The updates include new ad formats, improved targeting, and enhanced measurement tools.",
      ...
      { type: "callout", content: ["\u{1F4A1} Pro Tip: Keep Reels ads under 15 seconds for optimal engagement. Short, punchy content performs best."] },
  ...
  "seo-core-update": {
    ...
    paragraphs: [
      { type: "text", content: [
        "Google has released its latest core algorithm update, bringing significant changes to how websites are ranked in search results. The update focuses on rewarding high-quality content and improving the visibility of helpful, people-first content.",
