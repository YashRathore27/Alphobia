...
const b = (key) => BRANDS[key] || EXTRA_BRANDS[key] || { bg: "#64748b", label: "?" };
const p = (id) => {
...
const CATEGORIES = [
  ...
  },
  {
    ...
    icon: "Smartphone",
    bg: "bg-emerald-500",
    image: "/images/smartphoneIcon.jpg",
  ...
  },
  {
    ...
    icon: "Watch",
    bg: "bg-amber-500",
    image: "/images/WearablesIcon.png",
  ...
  },
  {
    ...
    icon: "Shirt",
    bg: "bg-pink-500",
    image: "/images/ClothingIcon.jpeg",
  ...
  },
  {
    ...
    icon: "Plug",
    bg: "bg-blue-500",
    image: "/images/AppliancesIcon.png",
  ...
  },
  {
    ...
    icon: "Tv",
    bg: "bg-slate-900",
    image: "/images/ElectronicsIcons.png",
