...
for (const cat of categories) {
  ...
  items.forEach(([name, brand, domain, price, originalPrice, description], i) => {
    ...
    products.push({
      ...
      brand,
      brandDomain: domain,
      logo: domain === "ahrefs.com" ? "/images/AhrefsLogo.png" : logoUrl(domain),
      category: cat.id,
      ...
      store: storeName,
      storeDomain,
      storeLogo: storeDomain === "ahrefs.com" ? "/images/AhrefsLogo.png" : logoUrl(storeDomain),
...
export const coupons = Array.from({ length: 84 }, (_, i) => {
  ...
  return {
    ...
    merchantLogo: domain === "ahrefs.com" ? "/images/AhrefsLogo.png" : logoUrl(domain),
    category: catId,
    gradient: cat.gradient,
...
export const marketingTools = [
  ...
  { id: "mt-2", name: "Ahrefs", domain: "ahrefs.com", logo: "/images/AhrefsLogo.png", tag: "SEO & Backlinks", rating: 4.8, users: "Trusted by 44% of F500", color: "#054ADA" },
