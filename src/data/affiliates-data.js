const AFFILIATES_DATA = {
  amazon: {
    ...
    description: "The Amazon Associates Program helps content creators, publishers and bloggers monetize their traffic with the world's largest product catalog.",
    tags: [
    ...
    earningsDefault: { visitors: 1e4, conversion: 2, aov: 50 }
  },
  clickbank: {
    brandKey: "clickbank",
    name: "ClickBank",
    ...
    description: "ClickBank is a leading affiliate marketplace for digital products. With high commission rates up to 75%, it's the go-to platform for affiliates promoting courses, eBooks and software.",
    tags: [
    ...
    earningsDefault: { visitors: 5e3, conversion: 3, aov: 40 }
  }
};
export {
  AFFILIATES_DATA
